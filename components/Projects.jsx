...
const projectData = [
    ...
    },
    {
        number: '03',
        title: "Nandi Scan V2",
        description: "An upgraded version of the original Nandi Scan with significantly improved user interface and enhanced server functionality for better performance and usability. Contact me for enabling ai features as they are not yet hosted for public use and haave to start my server for that",
        techStack: ["Dart", "Flutter", "Backend API"],
        videoUrl: "",
        githubUrl: "https://github.com/moksh1249/nandi-scan-v2",
        liveUrl: "https://moksh1249.github.io/deployed-nandi-scan-v2/",
